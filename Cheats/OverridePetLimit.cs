...
{
    internal class OverridePetLimit : CustomCommand
    {
        public override string Name => "Override Pet Limit Cheat";
        ...
        public override void Execute(CommandInput message)
        {
            ...
            Utils.DisplayMessage("Override Pet Limit Cheat: " + (overrideOn ? "Enabled" : "Disabled"));
        }
